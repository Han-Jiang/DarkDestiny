...
* @Description:  Building command , set the location and direction 
* of the buidling and add it to the map
...
public class BuildingCommand extends CommandFactory implements Command{
	...
	/* (non-Javadoc) 
	* <p>Title: execute</p> 
	* <p>Description: execute the building command</p> 
	...
	*/ 
	...
	public void execute() throws InstantiationException, IllegalAccessException, ClassNotFoundException, IOException {
		Building building = (Building) Class.forName(Constant.TILE_PACKAGE + commandData.get("tileName")).newInstance();
